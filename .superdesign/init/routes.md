...
Routing is configured with React Router v6 in `src/App.tsx`. Authenticated product pages render their own `MainLayout`; system-admin pages use `SystemLayout`.

## Key route map

| URL | Component | Layout / notes |
| --- | --- | --- |
| `/` | `src/pages/Dashboard.tsx` | Protected, MainLayout |
| `/exceptions` | `src/pages/ExceptionDashboard.tsx` | Protected, MainLayout |
| `/shipments` | `src/pages/Shipments.tsx` | Protected by `ship_view`, MainLayout |
| `/shipments/add` | `src/pages/AddShipment.tsx` | Protected by `ship_add`, MainLayout |
| `/shipments/:id/edit` | `src/pages/ShipmentDetail.tsx` | Protected by `ship_view`, MainLayout |
| `/master-customers` | `src/pages/MasterCustomers.tsx` | Protected, MainLayout |
| `/sales/leads` | `src/pages/Leads.tsx` | Protected, MainLayout |
| `/sales/rate-requests` | `src/pages/RateRequests.tsx` | Protected, MainLayout |
| `/sales/quotations` | `src/pages/Quotations.tsx` | Protected, MainLayout |
| `/accounts/invoices` | `src/pages/Invoices.tsx` | Protected, MainLayout |
| `/settings` | `src/pages/Settings.tsx` | Protected, MainLayout |
| `/login` | `src/pages/Login.tsx` | Public auth page |
| `/system/*` | `src/pages/system/*` | Separate system-admin shell |
