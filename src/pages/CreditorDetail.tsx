...
const customerTypes = ["Co-loader", "Shipping Line", "Carrier", "Transporter", "Customs Agent"];
...
const CreditorDetail = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    category: ["Co-loader"],
    name: "NEUTRAL CONSOLIDATORS FREIGHT LLC.",
    city: "DUBAI",
    country: "United Arab Emirates",
    phone: "00971 4 393 5702",
    fax: "",
    generalEmail: "rajasaad@neutralfreight-dxb.com",
    ntnVatTaxNo: "123456",
    taxPercentage: "",
    address: "",
    status: "Active",
